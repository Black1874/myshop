            ...
            <li class="denglu">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.get('user')}">
                        <a class="blue" href="#">${sessionScope.get('user').username}</a>
                    </c:when>
                    <c:otherwise><a class="red" href="/getLoginForm">请登录!</a></c:otherwise>
                </c:choose>
                <a href="zhuc.html">[免费注册]</a></li>
            <li class="shu"></li>
...
<!--搜索栏-->
<div class="toub_beij">
    <div class="logo"><a href="../frontLogin"><img src="./images/logo.png"></a></div>
    <div class="search">
...
<!--轮播图-->
<div id="lunbo">
    <c:set value="${result.data}" var="list"></c:set>
    <ul id="one">
        <c:forEach items="${list}" var="content" >
            <li><a href=""><img src="http://localhost:8080/content/getPic?fileName=${content.pic1}"></a></li>
        </c:forEach>
