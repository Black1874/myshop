...
<div class="content-wrapper">
    <section class="content">
        <%--标题--%>
        <div class="row">
            <h3 style="padding-left: 15px">${result.data.id eq null ? "新建类别" : "修改类别"}</h3>
        </div>
        <%--表单--%>
        <div class="row">
            <div class="box box-primary">
                ...
                <%--<form role="form" id="categoryForm" action="/category/saveCategory" method="post">--%>

                    <%--</c:when>--%>
                    <%--<c:otherwise>--%>
                    <%--<form role="form" id="categoryForm" action="/category/updateCategory" method="post">--%>
                        <%--</c:otherwise>--%>
                        <%--</c:choose>--%>
                    <form role="form" id="categoryForm" action="/category/formDispatcher" method="post">
                            <div class="box-body">
