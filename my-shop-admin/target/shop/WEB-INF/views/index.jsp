...
<div class="login-box">
    ...
    <div class="login-box-body">
        <c:if test="${not empty result.message}">
            <p class="callout callout-danger">${result.message}</p>
        </c:if>
        ...
        <div class="social-auth-links text-center">
            <p>- OR -</p>
            <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-weixin"></i> WEXIN</a>
            <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-qq"></i>QQ</a>
        </div>
        <!-- /.social-auth-links -->
